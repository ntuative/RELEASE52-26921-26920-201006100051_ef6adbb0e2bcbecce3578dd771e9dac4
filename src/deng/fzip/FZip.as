package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_553 = new FZipFile(this,charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  var_98 = parseIdle;
                  break;
               default:
                  dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_134,"Unknown record signature."));
            }
            return true;
         }
         return false;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_134))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_134,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_97 && var_98 == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_134,"EOF"));
            }
         }
      }
      ...
      {
         if(var_553.parse(param1))
         {
            var_49.push(var_553);
            if(false)
            {
               var_147["null"] = var_553;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1354,var_553));
            var_553 = null;
            if(var_98 != parseIdle)
            {
               var_98 = parseSignature;
      ...
      {
         var _loc2_:* = null;
         if(var_49 != null && var_147 != null && param1 < var_49.length)
         {
