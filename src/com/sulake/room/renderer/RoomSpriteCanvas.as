package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_2080:Number = -1.0E7;
      
      private var var_2077:Number = -1.0E7;
      
      private var var_2429:int = 0;
      
      private var var_525:RoomObjectCache;
      
      private var var_749:int;
      
      private var var_277:Sprite;
      
      private var var_1093:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_316 = new Map();
         var_525 = new RoomObjectCache(_loc6_);
      ...
      {
         var_525.removeObjectCache(param1);
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_54.graphics.beginFill(var_2429);
      ...
      {
         var _loc11_:Number = param1 - var_749 / 2;
         var _loc12_:Number = param2 - var_748 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_749 != var_2078 || var_748 != var_2079)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
         ...
         var_437.sortOn("z",0 | 0);
         if(_loc5_ < var_437.length)
         {
            var_437.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = var_437[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_527.length)
            {
               cleanSprite(var_527[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_527 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_316 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_316.getKey(_loc1_);
            _loc3_ = var_316.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1093 != null)
                  {
                     var_1093.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1581,geometry);
                  }
                  else
                  {
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var_1092.x = param1;
         var_1092.y = param2;
         if(var_901 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return var_1582;
         }
         var_1582 = checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++var_901;
         return var_1582;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_437.length)
         {
            return null;
         }
         return var_437[param1] as SortableSprite;
      }
      
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         if(var_316 != null && param1 != null)
         {
            var_316.add(param2,param1);
         }
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_526.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_526.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2080 || param2 != var_2077)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_526.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_526.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_527.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_525.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_525.getObjectCache(param2);
         ...
         _loc13_ += int(var_749 / 2);
         _loc14_ += int(var_748 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_749 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_748))
                  {
