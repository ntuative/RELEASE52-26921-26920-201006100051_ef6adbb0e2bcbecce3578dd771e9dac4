package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_623:Number = 64;
      
      public static const const_1046:Number = 32;
      ...
      private var var_1607:Number = 1.0;
      
      private var var_2432:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_86 = new Vector3d();
         var_1104 = new Vector3d();
         var_1606 = 1;
         var_1605 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1607 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(var_243.x != _loc2_ || var_243.y != _loc3_ || var_243.z != _loc4_)
         {
            ++var_79;
         }
      ...
      {
         if(var_442 != param1 * var_1607)
         {
            var_442 = param1 * var_1607;
            ++var_79;
         }
      }
      ...
      {
         if(var_444 != param1 * var_1606)
         {
            var_444 = param1 * var_1606;
            ++var_79;
         }
      }
      ...
      {
         if(var_443 != param1 * var_1605)
         {
            var_443 = param1 * var_1605;
            ++var_79;
         }
      }
      ...
      {
         return new Vector3d(var_243.x,var_243.y,var_243.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1104.assign(_loc22_);
         }
         else
         {
            var_1104.assign(_loc17_);
         }
         ++var_79;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_443;
         _loc2_.z *= var_442;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1104);
         if(_loc3_ < var_2433 || _loc3_ > var_2432)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_443;
            _loc2_.z *= var_442;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1104);
         }
      ...
      {
         return new Vector3d(0 * var_444,0 * var_443,0 * var_442);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_444,0 * var_443,0 * var_442);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_86;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_444,param2.y * var_443,param2.z * var_442);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_444,param3.y * var_443,param3.z * var_442);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_444,param4.y * var_443,param4.z * var_442);
