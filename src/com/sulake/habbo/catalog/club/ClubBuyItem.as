package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyItem
   {
      ...
      public function ClubBuyItem(param1:ClubBuyOfferData, param2:ICatalogPage)
      {
         ...
         _window = var_406.viewer.catalog.windowManager.buildFromXML(_loc3_) as IWindowContainer;
      ...
      {
         if(!var_406 || true || !var_406.viewer.catalog || !var_406.viewer.catalog.assets)
         {
            return null;
         }
         var _loc2_:XmlAsset = var_406.viewer.catalog.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:ClubBuyController = (var_406.viewer.catalog as HabboCatalog).getClubBuyController();
         (var_406.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_78,var_406);
      }
   }
}
