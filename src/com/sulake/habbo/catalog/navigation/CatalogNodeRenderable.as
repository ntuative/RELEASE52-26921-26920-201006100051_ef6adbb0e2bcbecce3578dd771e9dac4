package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1073:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1475:XML;
      
      private static var var_1474:XML;
      ...
      private var var_1473:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1474 == null)
         {
            ...
            var_1474 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1473 == 4294967295)
            {
               var_1473 = _loc1_.color;
            }
            _loc1_.color = const_1073;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1320;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1475) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_51 = navigator.catalog.windowManager.buildFromXML(var_1474) as IItemListWindow;
         if(var_51 == null)
         {
