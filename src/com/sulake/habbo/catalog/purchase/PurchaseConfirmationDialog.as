package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1462:uint = 4.294967295E9;
      
      private const const_1461:uint = 4.293848814E9;
      
      private var var_850:int;
      
      private const const_1714:uint = 4.291613146E9;
      ...
      private const const_1715:int = 10;
      ...
      {
         return param1 % 2 == 0 ? uint(const_1461) : uint(const_1462);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1488;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = _catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_85);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_406,var_78,var_1039);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(var_591[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_590[var_196]);
         _catalog.purchaseProductAsGift(var_406,var_78,var_1039,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_131:
               ...
               if(var_1847 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_247)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1715)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1847 = _loc3_.text;
               break;
            case WindowMouseEvent.const_53:
               showSuggestions(false);
               if(var_1249)
               ...
               break;
            case WindowKeyboardEvent.const_660:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1488 = _loc1_.stuffTypes;
            var_591 = _loc1_.boxTypes;
            var_590 = _loc1_.ribbonTypes;
            var_851 = var_1488[0];
            _boxIndex = var_591[0];
            var_196 = var_590[0];
            initColorGrid();
