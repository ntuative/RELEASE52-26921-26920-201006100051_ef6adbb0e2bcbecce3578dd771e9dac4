package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         var_324 = null;
         for each(_loc1_ in var_1372)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1371) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_764.width,var_764.height,true,0);
               _loc3_.bitmap.copyPixels(var_764,var_764.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_926.width,var_926.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_763.width,var_763.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_763,var_763.rect,new Point(0,0),null,null,true);
