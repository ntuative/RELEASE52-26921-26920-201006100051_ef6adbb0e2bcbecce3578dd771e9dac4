package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_587[var_1035] as Array;
      ...
      {
         var _loc2_:Offer = var_587[var_1035][var_1837];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.method_5 == Offer.const_493 || _loc1_.method_5 == Offer.const_405)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_86 || _loc3_.productType == ProductTypeEnum.const_85)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1034.indexOf(_loc5_) == -1)
                        {
                           ...
                           var_587.push(new Array());
                        }
                        _loc6_ = var_1034.indexOf(_loc5_);
                        (var_587[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_587)
         {
            if(var_1837 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1837] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1035 = var_984.getGridItemIndex(param1.view);
