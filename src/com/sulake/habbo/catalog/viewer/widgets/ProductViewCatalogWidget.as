package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1352:IScrollbarWindow;
      
      protected var var_1240:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_627 != null)
         {
            var_627.visible = false;
            var_627.destroyGridItems();
         }
         if(var_1352 != null)
         {
            var_1352.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1426.text = "${" + _loc3_.name + "}";
            var_1427.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1426.text = "${" + _loc2_.localizationId + "}";
            var_1427.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.method_5)
            {
               case Offer.const_515:
                  _loc4_ = var_1351.clone();
                  if(var_627 != null)
                  {
                     var_627.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_627,var_1352,var_1240);
                  }
                  break;
               ...
               case Offer.const_405:
                     ...
                     case ProductTypeEnum.const_229:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_270,AvatarAction.const_433);
                              _loc13_.appendAction(AvatarAction.const_482,_loc6_.productClassId);
                  ...
                  break;
               default:
                  Logger.log("[ProductViewCatalogWidget] Unknown pricing model" + _loc2_.method_5);
            }
      ...
      {
         var_1426 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1427 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1611 = new Point(var_84.x,var_84.y);
         var_627 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1352 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_627 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1240 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1351 = _loc2_.content as BitmapData;
