package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1218:String = "default";
      ...
      private var var_1217:String = "1.1";
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               {
                  case "floor":
                     for each(_loc9_ in var_129.floors.pattern)
                     {
                     ...
                     break;
                  case "wallpaper":
                     for each(_loc10_ in var_129.walls.pattern)
                     {
                     ...
                     break;
                  case "landscape":
                     for each(_loc11_ in var_129.landscapes.pattern)
                     {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_258 != null && var_255 != null)
         {
            setRoomImage(var_258,var_255);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_129.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_224 >= 0)
         ...
         for each(_loc1_ in var_129.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_257];
               if(_loc11_ != null)
               {
         ...
         for each(_loc1_ in var_129.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_256];
               if(_loc13_ != null)
               {
                  var_1217 = _loc13_.@id;
               }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_196:
               ...
               var_694 = 0;
               _loc5_ = "null";
               for each(_loc8_ in var_129.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_694 = _loc8_.children().length();
                  }
               }
            ...
            case const_197:
               ...
               if(var_301 >= _activeFloorPatterns.length)
               {
                  var_301 = 0;
               }
               var_257 = 0;
               ...
               for each(_loc9_ in var_129.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_693 = _loc9_.children().length();
                  }
               }
            ...
            case const_87:
               ...
               var_695 = 0;
               _loc7_ = "null";
               for each(_loc10_ in var_129.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_695 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1218);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1202[var_300];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1217);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1218,var_1217,64,this,"window_romantic_wide");
