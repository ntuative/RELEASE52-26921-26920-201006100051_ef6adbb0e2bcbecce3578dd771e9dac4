package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1135:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1135 != null)
         {
            var_1135.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1134 != null)
         {
            var_1134.removeEventListener(WindowKeyboardEvent.const_156,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1135 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1135 != null)
         {
            var_1135.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1134 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1134 != null)
         {
            var_1134.addEventListener(WindowKeyboardEvent.const_156,windowKeyEventProcessor);
         }
      }
