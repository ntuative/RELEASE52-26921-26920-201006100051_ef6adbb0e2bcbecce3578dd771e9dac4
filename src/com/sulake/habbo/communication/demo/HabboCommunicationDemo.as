package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_421:IKeyExchange;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1926)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_723 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_723);
            _loc2_.send(_loc4_);
      ...
      {
         var_1056 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_226);
         param1.send(new VersionCheckMessageComposer(401,var_1282,var_1925));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_421.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_421.getSharedKey(16).toUpperCase();
      ...
      {
         var_723 = _habboConfiguration.getKey("sso.ticket",null);
         var_1282 = _habboConfiguration.getKey("flash.client.url","");
         var_1925 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_178 == null)
         {
         ...
         if(var_723 != null)
         {
            var_62.mode = HabboConnectionType.const_511;
            var_62.initConnection(HabboConnectionType.const_276);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1541 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_734);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(var_62.mode)
         {
            case HabboConnectionType.const_511:
               _loc6_ = "";
               ...
               var_1057 = _loc4_;
               var_178.loadBannerImage(_loc7_ + "?token=" + var_1057,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1024:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1419:
               var_604 = generateRandomHexString(30);
               var_421 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_421.init(var_604);
               _loc8_ = var_421.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1057);
         ...
         var_421 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_421.init(_loc14_);
            _loc15_ = var_421.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_62.mode = HabboConnectionType.const_1024;
            }
         }
         var_62.initConnection(HabboConnectionType.const_276);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_195,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_110,onRoomSessionEnded);
      }
