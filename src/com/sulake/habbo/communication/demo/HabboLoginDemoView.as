package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_185:HabboCommunicationDemo;
      ...
      {
         var_185.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_185.shockwaveClientUrl = var_121.shockwaveClientUrl;
         var_185.ssoTicket = var_121.ticket;
         var_121.removeEventListener(SSOTicket.const_360,onParsedTicketSuccess);
         var_121.removeEventListener(SSOTicket.const_273,onParsedTicketFailure);
         var_121 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1455,"/");
      ...
      {
         var _loc8_:* = null;
         var _loc1_:XmlAsset = (var_185 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_185.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_114,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_185.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1455,"/");
         if(_loc5_ != null)
         {
         ...
         if(false)
         {
            if(var_185.habboConfiguration.getKey("use.sso","false") == "true")
            {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_185.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_185.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_185.habboCommunication.method_7(name,password);
         var_121 = new SSOTicket(var_185.assets,_loc2_,_loc1_);
         var_121.addEventListener(SSOTicket.const_360,onParsedTicketSuccess);
         var_121.addEventListener(SSOTicket.const_273,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_185.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_185.windowManager.buildFromXML(_loc3_.content as XML);
