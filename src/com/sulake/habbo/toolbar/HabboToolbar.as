package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_138,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_901,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_193,onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_441,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_635,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_917,onHideWindowEvent);
         var_37 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_93));
      }
