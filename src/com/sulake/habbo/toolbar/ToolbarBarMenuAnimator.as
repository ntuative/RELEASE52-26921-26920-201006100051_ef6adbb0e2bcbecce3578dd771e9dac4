package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1168:Number = 90;
      
      private static const const_800:int = 50;
      
      private static const const_1127:Number = 25;
      ...
      private var var_1079:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_518.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_518.splice(_loc3_,1);
            var_517.splice(_loc3_,1);
         }
         var_517.push(param1.name);
         var_518.push(param2);
         param1.addEventListener(WindowEvent.const_417,windowEventListener);
         param1.addEventListener(WindowEvent.const_245,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_518[var_517.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1079.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1079.getIconLoc(param1.iconId);
      ...
      {
         return var_517[var_518.indexOf(param1)];
      }
      ...
      {
         return param1.x + param1.width < const_800 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_800 || param1.desktop.height - param1.y < const_1128;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_517[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
