package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_871:String = "group_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1422:
               if(var_129 != null)
               {
                  _loc5_ = var_129.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_871:
               if(var_129 != null)
               {
                  if(var_129 != null)
                  {
                     _loc5_ = var_129.getKey("group.badge.url");
