package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1072:UserDataManager;
      ...
      {
         if(var_37 == RoomSessionEvent.const_357 && _connection != null)
         {
            var_37 = RoomSessionEvent.const_99;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1072 as IUserDataManager;
      }
