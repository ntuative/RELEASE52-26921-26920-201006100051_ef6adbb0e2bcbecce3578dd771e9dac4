package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_776:uint = 11;
      
      private static var _instance:HabboTracking;
       
      
      private var var_223:LatencyTracker = null;
      ...
      private var var_825:LagWarningLogger = null;
      
      private var var_826:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_476 = new FramerateTracker();
         var_223 = new LatencyTracker();
         var_825 = new LagWarningLogger();
         var_1194 = new Array(const_776);
         var _loc4_:int = 0;
         while(_loc4_ < const_776)
         {
            var_1194[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1369,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1269,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_543,String(false));
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1253);
               break;
            case HabboCommunicationEvent.const_734:
               trackLoginStep(HabboLoginTrackingStep.const_1276,String(_communication.port));
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_223 != null)
            {
               var_223.communication = _communication;
               var_223.connection = param1;
            }
            if(var_825 != null)
            {
               var_825.connection = param1;
            }
         }
      }
      ...
      {
         var_129 = IHabboConfigurationManager(param2);
         if(var_129)
         {
            Component(var_129).events.addEventListener(HabboConfigurationEvent.const_195,onConfigurationLoaded);
            if(var_223 != null)
            {
               var_223.configuration = var_129;
            }
            if(var_222 != null)
            {
               var_222.configuration = var_129;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_267.events.addEventListener(AdEvent.const_451,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1738)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1196);
            var_1738 = true;
         }
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_543,String(true));
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_358:
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_826)
            {
               var_826.release(new IIDHabboWindowManager());
               var_826 = null;
            }
            if(var_267)
            {
            ...
            if(var_173)
            {
               if(true)
               {
                  ...
                  Component(var_173).events.removeEventListener(HabboFriendListTrackingEvent.const_358,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_473,onLagWarningEvent);
               }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_734,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_597,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_66,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_382,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_473:
               var_825.warpingDetected();
         }
      }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_129)
         {
            if(var_825 != null)
            {
               var_825.configure(var_129);
            }
            if(var_476 != null)
            {
               var_476.configure(var_129);
            }
            Component(var_129).events.removeEventListener(HabboConfigurationEvent.const_195,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_849);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_849,onCoreRunning);
         }
      }
      ...
      {
         var_826 = IHabboWindowManager(param2);
         if(var_826)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1015 > -1 && _loc2_ < var_1015)
         {
            ++var_1470;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1470);
         }
         if(var_1015 > -1 && _loc2_ - var_1015 > 15000)
         {
            ++var_1471;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1471);
         }
         var_1015 = _loc2_;
         if(var_222 != null)
         {
         ...
         if(var_476 != null)
         {
            var_476.trackUpdate(param1,this);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_129 != null && !Boolean(var_129.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_473,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_286,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_173).events.addEventListener(HabboFriendListTrackingEvent.const_358,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_129)
            {
               if(var_129.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_129.getKey("client.fatal.error.url");
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_597)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1198);
         }
         else if(param1.type == HabboHotelViewEvent.const_382)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1379);
         }
         else if(param1.type == HabboHotelViewEvent.const_66)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1176);
         }
      }
   }
}
