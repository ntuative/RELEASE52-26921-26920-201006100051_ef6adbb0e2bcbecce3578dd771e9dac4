package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1928:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26921-26920-201006100040");
         _toolbar = param5;
         var_109 = new Map();
         var_109.add(HabboHelpViewEnum.const_1394,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_153,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_384,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_284,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_240,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_619,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_326,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_699,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_235,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_109.add(HabboHelpViewEnum.const_1036,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_621,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_268 == HabboHelpViewEnum.const_153 || false)
         {
            return;
         }
         if(var_422 == null)
      ...
      {
         return var_109.getValue(var_268);
      }
      ...
      {
         var_1929 = param1;
         var _loc2_:IHelpViewController = var_109.getValue(HabboHelpViewEnum.const_153) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_923:
               showUI(HabboHelpViewEnum.const_1036);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_268 == HabboHelpViewEnum.const_153)
         {
            return;
         }
         if(true)
         {
            ...
            var_605.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_605[1],var_605[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_605[0],var_605[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1543;
         _window.width = _loc1_.width + var_1542;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_268);
            return;
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_404));
      }
