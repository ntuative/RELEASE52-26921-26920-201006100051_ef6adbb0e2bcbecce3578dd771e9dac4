package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         var_751 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_750 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_136 = new Map();
      }
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(var_750.hasItem(param1))
         {
            var_750.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
