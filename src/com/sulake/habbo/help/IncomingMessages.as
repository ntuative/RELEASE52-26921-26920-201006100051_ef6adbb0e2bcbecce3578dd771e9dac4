package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_22.tellUI(HabboHelpViewEnum.const_240,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_284,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_153);
      }
      ...
      {
         var_22.showUI(HabboHelpViewEnum.const_326);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_22.showUI(HabboHelpViewEnum.const_384);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_22.showUI(HabboHelpViewEnum.const_619);
         var_22.tellUI(HabboHelpViewEnum.const_619,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.method_1 != _userId && _loc5_.userType == RoomObjectTypeEnum.const_343)
            {
               var_22.userRegistry.registerUser(_loc5_.method_1,_loc5_.name);
            }
            if(_loc5_.method_1 == _userId)
            {
               var_1863 = _loc5_.id;
            }
            _loc4_++;
         }
         var_22.tellUI(HabboHelpViewEnum.const_621);
      }
