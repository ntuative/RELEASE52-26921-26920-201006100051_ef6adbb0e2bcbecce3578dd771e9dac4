package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_867:IAvatarRenderManager;
      ...
      private var var_1571:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_619:ISessionDataManager;
      ...
      private var var_2044:FriendListLookAndFeel;
      ...
      {
         var_2044 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_92 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1571 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_357.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_357.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_411.findTab(FriendListTab.const_88).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var_619 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_357 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_92.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_92.addCategory(new FriendCategory(FriendCategory.const_999,getText("friendlist.friends")));
         var_92.addCategory(new FriendCategory(FriendCategory.const_502,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_521)
         {
            var_521 = new Timer(120000);
            var_521.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_521.start();
         }
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_138,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_521.stop();
            var_521.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_521 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_867)
         {
            var_867.release(new IIDAvatarRenderManager());
            var_867 = null;
         }
         if(var_893)
         {
            var_893.release(new IIDHabboNotifications());
            var_893 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_619)
         {
            var_619.release(new IIDSessionDataManager());
            var_619 = null;
         }
         super.dispose();
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_92);
      ...
      {
         var _loc1_:String = var_129.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_358));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1571.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_357.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_619.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_619.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_357.limit)
         {
            var_357.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_411.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_867.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_357.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_411.findTab(FriendListTab.const_88);
      ...
      {
         return var_129.getKey(param1,param1,param2);
      }
