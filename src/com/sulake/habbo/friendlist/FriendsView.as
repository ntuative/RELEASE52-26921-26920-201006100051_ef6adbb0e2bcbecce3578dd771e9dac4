package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2126:IContainerButtonWindow;
      
      private var var_2124:IContainerButtonWindow;
      
      private var var_2127:IContainerButtonWindow;
      
      private var var_2125:IContainerButtonWindow;
      ...
      {
         var_2124 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2127 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2126 = initButton("room_invite",onInviteButtonClick,param1);
         var_2125 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_92,param4);
         _loc6_.visible = true;
      }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2124,isEnableMinimailButton(_loc1_));
         setEnabled(var_2127,isEnableHomeButton(_loc1_));
         setEnabled(var_2126,isEnableInviteButton(_loc1_));
         setEnabled(var_2125,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc7_.color = _friendList.laf.getRowShadingColor(FriendListTab.const_92,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         _friendList.tabs.findTab(FriendListTab.const_92).setNewMessageArrived(true);
      }
      ...
      {
         return _friendList.laf.getRowShadingColor(FriendListTab.const_92,param1);
      }
