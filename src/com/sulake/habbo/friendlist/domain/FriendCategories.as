package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategories
   {
      ...
      private var var_431:IFriendCategoriesDeps;
      ...
      private function updateCategories(param1:Array) : void
      {
         ...
         findCategory(FriendCategory.const_999).received = true;
      ...
      public function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc2_.updatedFriends)
         {
            ...
            var_431.messenger.setFollowingAllowed(_loc4_.id,_loc4_.followingAllowed && _loc4_.online);
            _loc6_ = isFriendOnline(_loc4_.id);
            if(_loc6_ && !_loc4_.online)
            {
               var_431.messenger.setOnlineStatus(_loc4_.id,_loc4_.online);
               var_431.notifications.addOfflineNotification(_loc4_.name,_loc4_.realName);
            }
            if(!_loc6_ && _loc4_.online)
            {
               var_431.messenger.setOnlineStatus(_loc4_.id,_loc4_.online);
               var_431.view.setNewMessageArrived();
               var_431.notifications.addOnlineNotification(_loc4_.name,_loc4_.figure,_loc4_.realName);
            }
