package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2440:IWindowContainer;
      ...
      private function startSearch() : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_283,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_471 == null)
         {
            var_471 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_471.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
