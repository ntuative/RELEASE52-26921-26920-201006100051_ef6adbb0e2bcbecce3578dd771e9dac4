package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_2067:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_2067 = new RoomThumbnailRenderer(param1);
         var_841 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_184,var_120.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_184.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_184.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_841.refreshTags(_loc1_,var_120.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2067.refreshThumbnail(_loc1_,var_120.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_184 == null)
         {
            var_184 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_184.visible = true;
         Util.hideChildren(var_184);
         refreshRoomName(var_184,var_120);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_184,!true ? getEventCtg(var_120.categoryId) : getRoomCtg(var_120.categoryId));
         refreshRoomDesc(var_184,var_120);
         refreshExtraCont();
         refreshInfo(var_184,"trading_allowed",var_120.allowTrading);
         refreshInfo(var_184,"doormode_doorbell",false);
         refreshInfo(var_184,"doormode_password",false);
         Util.moveChildrenToColumn(var_184,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_184.height = Util.getLowestPoint(var_184);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_230,Tabs.const_219,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
