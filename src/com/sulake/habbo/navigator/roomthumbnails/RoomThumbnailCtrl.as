package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1586,this._model.mode != ThumbnailEditorModel.const_58);
         setEnabled(var_1587,this._model.mode != ThumbnailEditorModel.const_37);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1586 = IButtonWindow(find("top_tab"));
         var_1587 = IButtonWindow(find("obj_tab"));
         var_2092 = IWindowContainer(find("tile_grid"));
         var_2091 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1586,onTopTabButton);
         Util.setProcDirectly(var_1587,onObjTabButton);
      }
      ...
      {
         var _loc1_:IWindowContainer = var_2091;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_59,HabboWindowStyle.const_43,HabboWindowParam.const_77,new Rectangle(0,0,param1.width,66)));
