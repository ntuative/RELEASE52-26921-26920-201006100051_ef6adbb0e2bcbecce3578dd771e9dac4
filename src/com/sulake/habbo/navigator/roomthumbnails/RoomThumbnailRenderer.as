package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1165:int = -16;
      
      private static const const_820:int = 32;
      
      private static const const_1164:int = 8;
      
      public static const const_468:int = 10;
      
      private static const const_1163:int = 40;
      ...
      private var var_2279:Dictionary;
      
      private var var_958:ThumbnailImageConfigurations;
      
      private var var_1408:BitmapData;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_958 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_958.getImage(ThumbnailEditorModel.const_37,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1165,_loc4_.y + const_1163 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2279[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_958.getImage(ThumbnailEditorModel.const_42,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_958.getImage(ThumbnailEditorModel.const_42,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_958.getImage(ThumbnailEditorModel.const_58,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_820 / 2);
         return new Point(param1 * const_820 + _loc3_,param2 * const_1164);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         {
            var_1137[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1137[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_468)
         {
            if(false)
            {
               refreshObj(param1,var_1137[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1408 == null)
         {
            var_1408 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1408,var_1408.rect,new Point(0,0),null,null,true);
      }
   }
}
