package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
            ...
            case RoomSessionQueueEvent.const_416:
               ...
               switch(_loc2_.queueSetTarget)
               {
                  case RoomSessionQueueEvent.const_861:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_868:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc7_.length > 1)
               {
                  if(_loc6_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_988) != -1)
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_988) + 1;
                     _loc9_ = true;
                  }
                  else
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1263) + 1;
                  }
               }
               else
               {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_723);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_737);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_868);
               break;
            case RoomWidgetRoomQueueMessage.const_723:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_861);
               break;
            case RoomWidgetRoomQueueMessage.const_737:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_221,true);
               }
         }
         return null;
      }
