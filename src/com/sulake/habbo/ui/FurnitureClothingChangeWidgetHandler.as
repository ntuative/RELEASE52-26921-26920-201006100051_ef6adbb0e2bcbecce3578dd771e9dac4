package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1066:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      
      private static const const_1065:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      ...
      public function saveFigure(param1:String, param2:String) : void
      {
         ...
         _container.roomSession.sendUpdateClothingChangeFurniture(var_157,param2,param1);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_598,RoomWidgetClothingChangeMessage.const_307,RoomWidgetAvatarEditorMessage.const_312];
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         var _loc2_:RoomWidgetClothingChangeUpdateEvent = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_332);
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetClothingChangeMessage.const_307:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     var_157 = _loc7_.objectId;
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_847);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1065;
                     }
                     if(_loc7_.gender == FigureData.const_74)
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_886);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1066;
                        }
                     }
                     if(_container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_217,AvatarEditorFigureCategory.const_612],true))
                     {
                        _loc11_ = 0;
                        _container.avatarEditor.loadAvatarInEditor(_loc10_,_loc9_,_loc11_);
                        _loc2_ = _loc4_.getString(RoomObjectVariableEnum.const_116);
                        if(_loc2_ == null)
                        {
                           _loc2_ = "";
                        }
            ...
            case RoomWidgetAvatarEditorMessage.const_312:
               _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_332);
               _container.events.dispatchEvent(_loc5_);
         }
         return null;
      }
