package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1459:Number = 10;
      
      private static const const_1458:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1064,var_1065,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1064,var_725,var_1065,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1286 = param1.chatType;
         var_1064 = param1.userId;
         var_725 = param1.userName;
         var_1065 = param1.userCategory;
         _message = param1.text;
         var_1288 = param1.userX;
         var_204 = param1.userImage;
         var_1066 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_204 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_204.height);
         }
         ...
         if(var_204 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_204.width;
               _loc28_.height = var_204.height;
               _loc28_.bitmap = new BitmapData(var_204.width,var_204.height,true,0);
               _loc28_.bitmap.copyPixels(var_204,var_204.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_429 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_204.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_1066 != 0)
            {
               _loc30_ = uint(var_1066 >> 16 & 255);
               _loc31_ = uint(var_1066 >> 8 & 255);
               _loc32_ = uint(var_1066 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1286 == RoomWidgetChatUpdateEvent.const_275)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_725);
            }
            else if(var_1286 == RoomWidgetChatUpdateEvent.const_253)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_725);
            }
            else
            {
      ...
      {
         _widget.onItemMouseDown(var_1064,var_1065,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1064,var_1065,_roomId,_roomCategory,param1);
      }
