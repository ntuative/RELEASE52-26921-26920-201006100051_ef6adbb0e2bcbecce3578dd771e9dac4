package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_70,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_84,onObjectUpdate);
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_461,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_498,onObjectUpdate);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_125,onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_70,onEcotronUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_70,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_84,onObjectUpdate);
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_461,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_498,onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_70,onEcotronUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_450:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_461:
               if(!var_233)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_668,var_157);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_59,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1098,const_1097,2,2),null,0) as IWindowContainer;
