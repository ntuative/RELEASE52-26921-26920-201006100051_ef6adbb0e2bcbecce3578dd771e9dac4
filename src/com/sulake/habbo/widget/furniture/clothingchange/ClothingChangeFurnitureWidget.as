package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_795:String = "Girl";
      
      private static const const_794:String = "Boy";
      ...
      private var var_596:IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_873,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_332,onUpdate);
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_347:
               ...
               break;
            case RoomWidgetClothingChangeUpdateEvent.const_332:
               hideEditorInterface();
         }
      }
      ...
      {
         requestEditor(FigureData.const_75);
      }
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         var_1874 = param1.objectCategory;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_873,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_332,onUpdate);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         var_596 = _loc4_;
         var_596.offset(100,100);
         var _loc6_:IWindow = var_596.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_307,param1,var_157,var_1874,_roomId,_roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         if(var_596 != null)
         {
            _loc1_ = var_596 as IFrameWindow;
            if(_loc1_ != null)
            {
