package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_468:BitmapData;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in colors)
         {
            ...
            _loc3_.width = var_468.width;
            _loc3_.height = var_468.height;
            var_388.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_468.width,var_468.height,true,0);
               _loc4_.bitmap.copyPixels(var_468,var_468.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_810.width,var_810.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_678.width,var_678.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_678,var_678.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_388.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_388.numGridItems)
         {
            return;
         }
         select(var_388.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_324 != null)
         {
            _loc2_ = var_324.getChildByName("chosen");
            if(_loc2_ != null)
            {
