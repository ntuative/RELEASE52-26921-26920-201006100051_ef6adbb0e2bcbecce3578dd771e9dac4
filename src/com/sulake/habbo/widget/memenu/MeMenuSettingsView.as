package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_553);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_587);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_679));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_713 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1513);
               }
               break;
            case "sounds_on":
               if(var_713 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1512);
               }
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1514);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1512);
