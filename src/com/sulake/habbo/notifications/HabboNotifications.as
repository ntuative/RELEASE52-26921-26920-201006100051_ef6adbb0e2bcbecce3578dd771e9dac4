package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1151:String = "badges";
      
      private static const const_1152:String = "pet_inventory";
      
      private static const const_1155:String = "pixelbalance";
      
      private static const const_1154:String = "credits";
      
      private static const const_1156:String = "inventory";
      
      private static const const_1150:String = "friendlist";
      
      private static const const_1149:String = "selectfurni";
      
      private static const const_1153:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_634:ParkBusDialogManager;
      
      private var var_635:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_449:HabboNotificationViewManager;
      
      private var var_775:ClubEndingNotification;
      ...
      private var var_776:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_933);
         }
         var _loc6_:Map = var_933["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_776 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_207 == null)
         {
            return;
         }
         var_207.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_827)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1405);
         }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_207.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_207.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_635)
         {
            var_635.release(new IIDHabboToolbar());
            var_635 = null;
         }
         if(_windowManager)
         {
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_86:
               ...
               break;
            case CatalogPageMessageProductData.const_229:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2194)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_986);
            var_2194 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1152:
               if(var_11)
               {
                  var_11.toggleInventoryPage(InventoryCategory.const_152);
               }
               break;
            case const_1149:
               break;
      ...
      {
         if(param1 != null && this.var_449 != null)
         {
            var_449.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_986,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_979,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_188 || param2.type == WindowEvent.const_694)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_449.isSpaceAvailable() && false)
         {
            var_449.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_634 == null)
         {
            var_634 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_634 != null)
         {
            var_634.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1116.splice(0,1);
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               if(_loc8_.productType == CatalogPageMessageProductData.const_85)
               {
                  _loc9_ = var_363.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_86)
               {
                  _loc9_ = var_363.getWallItemData(_loc8_.furniClassId);
               }
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1326,_loc5_);
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1116.push(_loc8_);
         return var_1116.length;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1191)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_775 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_207 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      {
         var_635 = IHabboToolbar(param2);
         var_635.events.addEventListener(HabboToolbarEvent.const_93,onHabboToolbarEvent);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_207.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_363.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_858);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_858);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_207.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_93)
         {
            ...
            var_449 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_933["styles"],var_933["view"],var_635);
            ...
            registerUpdateReceiver(var_449,1);
            registerUpdateReceiver(this,2);
            var_363.events.addEventListener(BadgeImageReadyEvent.const_129,onBadgeImage);
            var_635.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
