package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_2461:uint = 0;
      
      private var var_1363:ProfilerAgentTask;
      
      private var var_1361:ProfilerOutput;
      
      private var var_767:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1362 = Component(param1).events;
         var_448 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_701 = new SkinContainer(_loc3_.content as XML,assets);
         var_767 = new WindowRenderer(var_701);
         var_245 = new Array(const_374);
         var _loc5_:int = 0;
         while(_loc5_ < const_374)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_767,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_245[_loc5_] = _loc4_;
            _loc5_++;
         }
         var_221 = var_245[const_1146];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_221.getMouseCursor().defineCustomCursorType(MouseCursorType.ARROW_LINK,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_221.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1217,_loc6_);
      }
      ...
      {
         return var_245[param1].getDesktopWindow().getChildAt(var_221.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1361 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1361 = new ProfilerOutput(_loc3_,this,var_767);
               var_1364 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1364);
               var_1363 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1363);
               var_1111 = true;
            }
         }
      }
      ...
      {
         return var_701.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1362.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_374 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1362.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         var_1362.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1412,new Date().getTime().toString());
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1368,param2.name + ": " + param2.toString());
            }
         }
      }
   }
