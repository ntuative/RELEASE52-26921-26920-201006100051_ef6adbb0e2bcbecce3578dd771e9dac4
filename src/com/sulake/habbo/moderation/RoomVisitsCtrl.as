package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2168.clone());
      ...
      {
         var_2168 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_51 = IItemListWindow(var_52.findChildByName("visits_list"));
