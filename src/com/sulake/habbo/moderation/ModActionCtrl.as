package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_938:IButtonWindow;
      
      private var var_1386:int;
      
      private var _main:ModerationManager;
      
      private var var_781:OffenceCategoryData;
      
      private var var_454:ITextFieldWindow;
      
      private var var_936:IButtonWindow;
      ...
      private var var_780:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_938 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_936 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_937.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1386,var_454.text,getBanLength(),var_1387));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_937.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1386,var_454.text,var_1387));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_781 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1386,var_454.text,var_1387));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_781 != null;
         if(this.var_780 != null)
         {
            var_52.findChildByName("offence_txt").caption = this.var_780.name;
            var_52.findChildByName("offence_category").visible = true;
         }
         else if(this.var_781 != null)
         {
            this.refreshButtons("offences_cont",2,var_781.offences,var_938,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_936,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_780 = var_781.offences[_loc3_];
         var_454.text = var_780.msg;
         var_321 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_937 = IDropMenuWindow(var_52.findChildByName("banLengthSelect"));
         prepareBanSelect(var_937);
