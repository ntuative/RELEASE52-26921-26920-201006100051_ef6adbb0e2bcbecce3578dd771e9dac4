package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1524:IIssueBrowserView;
      ...
      private const const_1742:String = "closed_issues";
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_348.view.width = var_235.container.width;
         var_348.view.height = var_235.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1717:
               if(var_1522 == null)
               {
                  var_1522 = new MyIssuesView(issueManager,this,var_235.container);
               }
               return var_1522;
            case const_1718:
               if(var_1524 == null)
               {
                  var_1524 = new OpenIssuesView(issueManager,this,var_235.container);
               }
               return var_1524;
            case const_1719:
               if(var_1523 == null)
               {
                  var_1523 = new PickedIssuesView(issueManager,this,var_235.container);
               }
               return var_1523;
            default:
               return null;
