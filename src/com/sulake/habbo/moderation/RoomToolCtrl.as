package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1049:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_607,_data.flatId),var_52,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_452);
         if(param1.flatId != var_452)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_452);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_718.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1302,_loc2_,var_454.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1050.isSelected,var_1049.isSelected,var_718.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1315);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1244);
      }
      
      public function populate() : void
      {
         var_51 = IItemListWindow(var_52.findChildByName("list_cont"));
         ...
         var_718 = ICheckBoxWindow(var_52.findChildByName("kick_check"));
         var_1050 = ICheckBoxWindow(var_52.findChildByName("lock_check"));
         var_1049 = ICheckBoxWindow(var_52.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_452));
         Logger.log("BEGINNING TO SHOW: " + var_452);
      }
   }
}
