package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1138:String = "goawaybus";
      
      private static const const_1137:String = "bus";
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1138:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_507,0,_loc4_,_loc5_);
                     break;
                  case const_1137:
                  case const_1136:
