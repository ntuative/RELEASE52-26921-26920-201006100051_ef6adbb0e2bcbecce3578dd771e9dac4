package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1591:int = 1500;
      
      private var var_1592:int = 255;
      
      private var var_1590:int = 255;
      
      private var var_1330:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_976,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_536,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_742,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_548,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_585,1);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1009,int(param1.bgOnly));
         var_1330 = _color;
         var_1592 = var_1391;
         var_1096 = _loc3_;
         var_1590 = _loc4_;
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_888:
               param2.setNumber(RoomObjectVariableEnum.const_742,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_983:
               param2.setNumber(RoomObjectVariableEnum.const_548,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_585,_loc3_);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_513:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_223)
               {
                  _loc5_ = "null";
               }
               var_392.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_739:
               _loc4_ = var_392.method_10(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = var_392.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_896,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_743:
               param2.setString(RoomObjectVariableEnum.const_714,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_595:
               param2.setString(RoomObjectVariableEnum.const_544,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_659:
               param2.setString(RoomObjectVariableEnum.const_751,param1.value);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_905)
         {
            ...
            {
               _loc7_ = var_1330 >> 16 & 255;
               _loc8_ = var_1330 >> 8 & 255;
               _loc9_ = var_1330 & 255;
               _loc10_ = var_1096 >> 16 & 255;
               _loc11_ = var_1096 >> 8 & 255;
               _loc12_ = var_1096 & 255;
               _loc13_ = (_loc2_ - var_905) / var_1591;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1592 + (var_1590 - var_1592) * _loc13_;
               _color = _loc3_;
               var_1391 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_536,_loc3_);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1408,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1334,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1360,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_194)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_146 || _loc13_ == RoomPlaneData.const_272)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
