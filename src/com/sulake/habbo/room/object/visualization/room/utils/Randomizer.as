package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1500:int = 16777216;
      
      public static const const_1527:int = 1;
       
      
      private var var_2425:int = 69069;
      
      private var var_1181:int = 1;
      
      private var var_2424:int = 5;
      
      private var var_1457:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1457 * param2);
      }
      ...
      {
         var _loc1_:int = var_2425 * var_1181 + var_2424;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
