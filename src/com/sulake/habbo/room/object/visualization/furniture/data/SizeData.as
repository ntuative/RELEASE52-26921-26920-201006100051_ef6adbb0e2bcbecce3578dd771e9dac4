package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1214:int = 360;
      
      private var var_1776:int = 0;
      
      private var var_697:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1214 / 2) % 360 / var_1214;
         ...
         {
            _loc6_ = int(var_225.getKey(_loc5_)) * var_1214;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_1020);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_908);
                  break;
               case "DARKEN":
