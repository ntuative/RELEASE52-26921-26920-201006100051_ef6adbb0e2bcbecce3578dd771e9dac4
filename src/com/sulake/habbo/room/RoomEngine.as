package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_524:String = "room";
      
      private static const const_802:int = -2;
      
      private static const const_523:String = "temporary_room";
      
      private static const const_301:String = "object_icon_sprite";
      
      private static const const_801:int = -3;
      
      private static const const_803:String = "overlay";
      ...
      private var var_617:NumberBank;
      ...
      private var var_739:RoomMessageHandler = null;
      
      private var var_738:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_312 = new Map();
         var_617 = new NumberBank(1000);
         var_1080 = new Map();
         var_313 = new Map();
         var_67 = new RoomObjectEventHandler(this);
         var_739 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_67 != null)
         {
            ...
            {
               return var_67.deleteWallItem(var_117,var_118,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_765) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_725) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_636) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_724) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_116);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_67 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_67.modifyWallItemData(var_117,var_118,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_450 != null)
         {
            var_450.release(new IIDRoomObjectVisualizationFactory());
            var_450 = null;
         }
         if(var_42 != null)
         {
         ...
         if(var_738 != null)
         {
            var_738.release(new IIDRoomRendererFactory());
            var_738 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_738.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_837;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_561);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_905);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1040);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_831) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_945);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_513,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_754,var_117,var_118,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_67 != null)
         {
            return var_67.modifyRoomObject(var_117,var_118,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_313.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_313.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_595,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_659,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_42 != null)
         {
            ...
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_263);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_67 != null)
         {
            var_67.handleRoomObjectEvent(param1,var_117,var_118);
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_12.sessionDataManager = var_363;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_236,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_345,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_324,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_834,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_975,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_869,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_285,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      {
         if(var_26 == null || var_450 == null || var_42 == null || var_738 == null || _communication == null || _habboConfiguration == null || !var_2017)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_300,RoomObjectCategoryEnum.const_69);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1327,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_801,RoomObjectCategoryEnum.const_263);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_117,var_118,var_1309);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_301);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_117,var_118,var_1309);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_301);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_450;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_26 != null)
         {
            if(false)
            {
               var_26.events.addEventListener(RoomObjectMouseEvent.const_239,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_458,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_407,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_185,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_740,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_124,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_132,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_141,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_485,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_418,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_406,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_431,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_61,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_403,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_411,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_286,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_467,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_333,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_329,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_507,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_925,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_488,roomObjectEventHandler);
               var_26.events.addEventListener(AvatarWalkWarpingWarningEvent.const_473,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_650) != 0)
         {
            return false;
         }
         if(var_67 != null)
         {
            return var_67.initializeRoomObjectInsert(var_117,var_118,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = var_313.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_285,param1,param2,param3,RoomObjectCategoryEnum.const_40));
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_983,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_888,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_236));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_462);
                     break;
                  case RoomObjectCategoryEnum.const_40:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_163);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_331);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_655)
         {
            var_2017 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_236,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_345,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_324,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_837,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_285,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_267.events.addEventListener(AdEvent.const_451,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_803) as Sprite;
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_738 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_519 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_42.getRoom(const_523);
         if(_loc10_ == null)
         {
            _loc10_ = var_42.createRoom(const_523,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_617.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_34:
            case RoomObjectCategoryEnum.const_32:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_236,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_462,param8);
               break;
            case RoomObjectCategoryEnum.const_40:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_163,param2);
               break;
            case RoomObjectCategoryEnum.const_69:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_194,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_272,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_714,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_544,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_751,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_513,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1080.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_862,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_617.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_802,RoomObjectCategoryEnum.const_263);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_301);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1561 - _loc12_.width / 2;
               _loc11_.y = var_1562 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_454,var_117,var_118,-1,RoomObjectCategoryEnum.const_228));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_67 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_300,const_524);
                  var_67.handleRoomObjectEvent(_loc14_,var_117,var_118);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_117,var_118,var_1309);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_301);
            _loc11_ = addOverlayIconSprite(_loc10_,const_301,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1561 - _loc6_.data.width / 2;
               _loc11_.y = var_1562 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_336,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_851,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_860,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_972,RoomObjectVariableEnum.const_336,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_655,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_67 != null)
         {
            var_67.cancelRoomObjectInsert(var_117,var_118);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_42.getRoom(const_523);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         var _loc7_:int = _loc3_.method_2(_loc6_);
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_862);
               ...
               var_617.freeNumber(_loc10_ - 1);
               _loc13_ = var_1080.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_117,var_118,const_300,RoomObjectCategoryEnum.const_69,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_874,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_650,1,true);
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_300,const_524,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_650,0,true);
         }
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_765,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_636,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_725,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_724,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_958,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_595,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_659,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_513,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_223);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_561,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_550,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_561,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_905,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1040,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_802,const_1129,RoomObjectCategoryEnum.const_263);
         _loc7_.createRoomObject(const_801,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_263);
         return _loc7_;
      }
