package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1313:int = 1;
       
      
      private var _closedConversations:Array;
      
      private var var_431:IConversationsDeps;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_656,0,var_431.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = var_431.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         _startIndex = Math.min(_startIndex,0 - var_431.getTabCount());
      ...
      {
         return var_431.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         while(_startIndex + var_431.getTabCount() <= _loc2_)
         {
            ++_startIndex;
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         var_431.addMsgToView(_loc3_,_loc4_);
      }
      ...
      {
         return new Message(Message.const_658,0,getOnlineText(param1),Util.getFormattedNow());
      }
      ...
      public function setFollowingAllowedAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         if(_loc3_.selected)
         {
            var_431.refresh(false);
         }
      }
      
      public function addTestUser() : void
      {
         this.addConversation(var_1313++);
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         var_431.addMsgToView(_loc3_,param1);
