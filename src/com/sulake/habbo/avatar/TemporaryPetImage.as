package com.sulake.habbo.avatar
{
   ...
   public class TemporaryPetImage extends PetImage
   {
      ...
      override public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc3_:BitmapData = getPlaceHolderImage(var_91,var_148);
         if(!_loc3_ || !_image)
         {
            return null;
         }
      ...
      override public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc2_:BitmapData = getPlaceHolderImage(var_91,var_148);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function getPlaceHolderImage(param1:int, param2:String) : BitmapData
      {
         ...
         _loc3_ += "_png";
         _loc6_;
         var _loc4_:BitmapData = var_473.getValue(_loc3_);
         if(!_loc4_)
         {
            ...
            _loc6_;
            var_473.add(_loc3_,_loc4_.clone());
            _loc4_ = var_473.getValue(_loc3_);
         }
         return _loc4_;
      }
