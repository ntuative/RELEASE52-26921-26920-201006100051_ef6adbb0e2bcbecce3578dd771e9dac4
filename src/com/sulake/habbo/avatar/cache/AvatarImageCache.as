package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1465:int = 60000;
      ...
      private var var_907:IAvatarImage;
      ...
      {
         if(var_622 == param1 || var_622 == GeometryType.const_928 && param1 == GeometryType.const_885 || param1 == GeometryType.const_928 && var_622 == GeometryType.const_885)
         {
            var_622 = param1;
            return;
         }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_596)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_496)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_80.getParts(param1,var_907.getFigure(),_loc6_,var_622,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_80.getCanvas(var_148,var_622);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1294[param1])
            {
            ...
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               if((_loc30_ == AvatarAction.const_881 || _loc30_ == AvatarAction.const_435) && (_loc6_ == AvatarBodyPartType.const_217 || _loc6_ == AvatarBodyPartType.const_1284 || _loc6_ == AvatarBodyPartType.const_1375) && _loc7_.color != null)
               {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         ...
         if(var_137 != null)
         {
            ...
            {
               _loc5_ = var_137.getValue(_loc4_) as AvatarImageBodyPartCache;
               if(_loc5_ != null)
               {
