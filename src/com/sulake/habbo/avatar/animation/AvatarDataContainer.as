package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1659,var_1658,var_1657,_alphaMultiplier);
         var_1030 = generatePaletteMapForGrayscale(var_1816,var_1818);
      }
      
      public function get reds() : Array
      {
         return var_1030.getValue("reds") as Array;
      }
      ...
      {
         return var_1030.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1030.getValue("greens") as Array;
      }
      ...
      {
         return var_1030.getValue("alphas") as Array;
      }
