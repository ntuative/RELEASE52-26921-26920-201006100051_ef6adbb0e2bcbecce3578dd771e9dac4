package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1572:PartOffsetData;
      
      private var var_894:AvatarActionManager;
      
      private var var_180:IAssetLibrary;
      
      private var var_895:IAssetLibrary;
      
      private var var_2045:AvatarRenderManager;
      
      private var var_315:FigureData;
      
      private var var_610:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_741:String;
      
      private var var_1573:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_180 = param2;
         var_895 = param3;
         var_315 = new FigureData();
         var_432 = new PartSetsData();
         var_610 = new AnimationData();
         var_1573 = new AvatarStructureDownloadSet();
         var_742 = new AnimationManager();
         var_741 = param4;
         var_1572 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_894.getActionDefinitionWithState(param1);
      }
      ...
      public function init() : void
      {
         ...
         switch(var_741)
         {
            case AvatarType.const_104:
               _loc1_ = var_180.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_432.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_180.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!var_610.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_180.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_315.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_180.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_432.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_180.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!var_610.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_180.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_315.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_894.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_315.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_894.getActionDefinition(param1);
      }
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_432.addPartDefinition(_loc11_);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1218[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_894.getDefaultAction();
         var _loc9_:Array = var_432.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_742.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_315.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_315.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_610.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_432.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_432.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_741 + " ready to go!");
         if(var_741 == AvatarType.const_104)
         {
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_104:
               if(var_180.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_180.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_180.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_180.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_104:
               if(var_180.hasAsset(_loc5_))
               {
                  var_180.removeAsset(var_180.getAssetByName(_loc5_));
               }
               var_1573.add(new AvatarStructureDownload(var_180,_loc5_,var_315));
               break;
            case AvatarType.PET:
         }
         var_1573.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_894 = new AvatarActionManager(var_180,var_741);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1315 = var_315.getMandatorySetTypeIds();
         return var_1315;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_315.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_895.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_895.getAssetByName("dance" + _loc1_).content as XML;
            var_742.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_895.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_895.getAssetByName("fx" + _loc1_).content as XML;
            var_742.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_1572.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_315.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_315.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1572.loadOffsets(var_895);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_894.sortActions(param1);
      }
   }
}
