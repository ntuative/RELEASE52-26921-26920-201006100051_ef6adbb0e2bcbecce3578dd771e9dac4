package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(_view != null)
         {
            var_544 = _view.findChildByName("part_thumbs") as IItemGridWindow;
            var_453 = new Array();
            var_453.push(_view.findChildByName("palette0") as IItemGridWindow);
            var_453.push(_view.findChildByName("palette1") as IItemGridWindow);
         }
      }
      ...
      private function paletteEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_53)
         {
            ...
            _loc7_ = 0;
            while(_loc7_ < const_1063)
            {
               if(var_453.length > _loc7_)
               {
                  _loc4_ = var_453[_loc7_] as IItemGridWindow;
      ...
      public function initFromList() : void
      {
         ...
         var_544.removeGridItems();
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               var_544.addGridItem(_loc2_.view);
         ...
         _loc3_ = 0;
         while(_loc3_ < const_1063)
         {
            _loc4_ = _loc1_.getPalette(_loc3_);
            _loc5_ = var_453[_loc3_] as IItemGridWindow;
            if(!(!_loc4_ || !_loc5_))
            {
      ...
      {
         var _loc3_:IWindow = var_544.getGridItemAt(param1);
         if(!_loc3_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_53)
         {
            _loc3_ = var_544.getGridItemIndex(param1.window);
