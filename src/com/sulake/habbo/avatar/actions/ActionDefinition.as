package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1903 = parseInt(param1.@precedence);
         var_1902 = String(param1.@activepartset);
         var_1901 = String(param1.@assetpartdefinition);
         var_1900 = String(param1.@lay);
         var_622 = String(param1.@geometrytype);
         var_1898 = Boolean(parseInt(param1.@main));
         var_1897 = Boolean(parseInt(param1.@method_11));
         var_1896 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1272 = _loc2_.split(",");
         }
      ...
      {
         return var_1272.concat(getTypePrevents(param1));
      }
