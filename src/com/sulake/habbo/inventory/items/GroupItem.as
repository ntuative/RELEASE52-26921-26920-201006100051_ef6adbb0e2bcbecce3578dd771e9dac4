package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2339:BitmapData;
      ...
      private const const_1443:Number = 0.2;
      
      protected var var_1434:Boolean;
      
      private const const_1444:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_646)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1445);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1443;
               _loc1_.blend = const_1443;
            }
            else
            {
               _window.blend = const_1444;
               _loc1_.blend = const_1444;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1434 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2339;
               _loc5_.visible = true;
            }
            else
            {
