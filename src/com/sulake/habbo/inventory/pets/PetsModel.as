package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_152 && false)
         {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1321 && param1.type == RoomEngineObjectEvent.const_220)
         {
            var_29.showView();
            var_1321 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1321 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_40,RoomObjectTypeEnum.const_315,_loc3_.figure);
            var_29.closeView();
            return;
         }
      ...
      {
         if(var_994.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
