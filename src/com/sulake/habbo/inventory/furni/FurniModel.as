package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_337:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_475 = new Timer(const_1072,1);
      ...
      {
         return var_29.getSubCategoryViewId() == InventorySubCategory.const_271;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_394.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_394.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_646)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_322)
         {
         ...
         if(var_692 == null)
         {
            var_692 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_692.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_271:
               ...
               break;
            case InventorySubCategory.const_959:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_29.checkCategoryInitilization(InventoryCategory.const_362);
         ...
         if(param1 == InventoryCategory.const_79 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_47:
                  ...
                  break;
               case const_337:
                  var_29.toggleInventoryPage(InventoryCategory.const_152);
            }
         }
      }
      ...
      {
         if(var_824 && param1.type == RoomEngineObjectEvent.const_220)
         {
            var_29.showView();
            var_824 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_363 || _loc3_.category == FurniCategory.const_322 || _loc3_.category == FurniCategory.const_351)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_394.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_394 = new Map();
         var_394.add(const_45,new Array());
         var_394.add(const_47,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
