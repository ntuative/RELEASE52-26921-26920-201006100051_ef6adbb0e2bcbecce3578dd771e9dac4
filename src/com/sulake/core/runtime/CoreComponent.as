package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private static const const_1115:String = "zip-libraries";
      ...
      private var var_728:IEventDispatcher;
      
      private var var_884:Profiler;
      
      private var var_272:uint;
      
      private var var_510:Array;
      
      private var var_271:LibraryLoaderQueue;
      
      private var var_608:Array;
      
      private var var_727:ProfilerViewer;
      ...
      public function CoreComponent(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_663 = (param2 & 0) == Core.CORE_SETUP_DEBUG;
         var_510 = new Array();
         var_608 = new Array();
         var_217 = param1;
         var _loc3_:int = 0;
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_1295:
               ...
               var_884 = new Profiler(this);
               attachComponent(var_884,[new IIDProfiler()]);
               var_727 = new ProfilerViewer();
               var_217.addChild(var_727);
               break;
      ...
      {
         return var_237 - getNumberOfFilesPending();
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(var_728)
         {
            ...
            var_728.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         var_728 = loadingEventDelegate;
         if(var_271 == null)
         {
            var_271 = new LibraryLoaderQueue(var_663);
         }
         try
         {
            node = config.child(const_1115)[0];
            if(node != null)
            {
               ...
               for each(item in list)
               {
                  ...
                  loader = new ZipLoader(context,true,var_663);
         ...
         {
            error("Failed to parse zip libraries from config xml!",true,Core.const_180,e);
         }
         try
         {
            ...
            if(node != null)
            {
               list = node.child(const_1119);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,var_663);
                  assets.loadFromFile(loader,true);
                  loader.load(new URLRequest(url));
                  var_271.push(loader);
                  loader.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,updateLoadingProcess);
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_180,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_180,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_180,e);
         }
         if(!disposed)
         {
         ...
         while(criticality < CoreComponent.const_144)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     var_884.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(var_728)
         {
            var_728.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function complexFrameUpdateHandler(param1:Event) : void
      {
         ...
         while(criticality < CoreComponent.const_144)
         {
            ...
            {
               if(var_608[criticality] < criticality)
               {
                  ++0;
                  skip = true;
               }
      ...
      private function updateLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(var_728)
               {
                  var_728.dispatchEvent(new LibraryProgressEvent(_loc2_.url,var_237 - 0,var_237,_loc2_.elapsedTime));
               }
            }
         }
         if(false)
