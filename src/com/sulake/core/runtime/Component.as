package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_961:uint = 4;
      
      public static const COMPONENT_EVENT_ERROR:String = "COMPONENT_EVENT_ERROR";
      
      public static const const_1531:uint = 1;
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_191.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_993 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_993);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1160 & const_961)
         {
            if(_loc3_ == 0)
            {
               if(var_191.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_191.getStructByIndex(_loc8_);
