package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1060:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_607:uint = 0;
      
      public static const const_633:String = "AssetLibraryReady";
      
      public static const const_1225:String = "AssetLibraryUnloaded";
      
      public static const const_386:String = "AssetLibraryLoaded";
      
      public static const const_1194:String = "AssetLibraryLoadError";
       
      
      private var var_507:XML;
      ...
      private var var_508:Boolean = true;
      
      private var var_352:Class;
      ...
      public function unload() : void
      {
         ...
         var_306 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1225));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_507 = _loc2_.manifest.copy();
         var_352 = _loc2_.resource;
         _file = _loc2_.url;
         if(var_508)
         {
            AssetLibrary.fetchLibraryContents(this,var_507,var_352);
         }
         var_306 = true;
         dispatchEvent(new Event(AssetLibrary.const_386));
         dispatchEvent(new Event(AssetLibrary.const_633));
         if(var_508)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1039,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_833,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_943,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_918,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1060.splice(var_1060.indexOf(this),1);
            --var_607;
            var_425 = null;
            var_724 = null;
            var_134 = null;
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1194));
         var_14 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_507.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_352[param1]);
      ...
      {
         var _loc2_:IAsset = var_134[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_35:
               ...
               if(decl != null)
               {
                  ...
                  var_134[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_50,e.status);
      ...
      {
         return var_352 != null ? false : false;
      }
   }
}
