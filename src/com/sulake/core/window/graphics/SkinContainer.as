package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_797:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1947 = new Dictionary();
         TypeCodeTable.fillTables(var_1546,var_1947);
         var_1290 = new Dictionary();
         var_1948 = new Dictionary();
         StateCodeTable.fillTables(var_1290,var_1948);
         var_512 = new Dictionary();
         var_512["skin"] = BitmapSkinRenderer;
         var_512["bitmap"] = BitmapDataRenderer;
         var_512["fill"] = FillSkinRenderer;
         var_512["text"] = TextSkinRenderer;
         var_512["shape"] = ShapeSkinRenderer;
         var_512["unknown"] = SkinRenderer;
         var_512["null"] = NullSkinRenderer;
         if(var_387 == null)
         {
            var_387 = new Array();
            var_387.push(WindowState.const_67);
            var_387.push(WindowState.const_76);
            var_387.push(WindowState.const_103);
            var_387.push(WindowState.WINDOW_STATE_SELECTED);
            var_387.push(WindowState.const_82);
            var_387.push(WindowState.const_81);
            var_387.push(WindowState.const_98);
            var_387.push(WindowState.const_89);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1290)
         {
            _loc3_.push(var_1290[_loc4_]);
         }
         if(param1 != null)
         {
      ...
      {
         var _loc3_:Array = var_730[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_731[param1] = new Array(SkinContainer.const_797);
         }
         var_731[param1][param2] = param3;
         if(true)
         {
            var_730[param1] = new Array(SkinContainer.const_797);
         }
         var_730[param1][param2] = param4;
      }
