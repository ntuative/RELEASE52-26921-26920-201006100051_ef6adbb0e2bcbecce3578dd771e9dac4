package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1672:String = "_INCLUDE";
      
      public static const const_1014:String = "_EXCLUDE";
      
      public static const const_1486:String = "_TEMP";
      ...
      protected var var_1156:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_985:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1157,var_1156);
         var_985 = new Dictionary();
         var_1442 = new Dictionary();
         ParamCodeTable.fillTables(var_985,var_1442);
         var_1441 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1106,"");
         return param1.replace(const_1105,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1156)
            {
               delete var_1156[_loc1_];
            }
            for(_loc1_ in var_985)
            {
               delete var_985[_loc1_];
            }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1014) == -1)
                  {
