package com.sulake.core.window.components
{
   ...
   public class SelectableButtonController extends ButtonController implements ISelectableWindow
   {
            ...
            if(var_9)
            {
               if(!(var_9 is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc3_.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_233,this,null));
                        break;
                     }
      ...
      public function select() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_342;
         update(this,_loc1_);
         return true;
      }
      ...
      public function unselect() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_730,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_569;
         update(this,_loc1_);
         return true;
      }
   }
