package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_779:String = "margin_top";
      
      private static const const_1080:String = "_HEADER";
      
      private static const const_778:String = "margin_right";
      
      private static const const_1082:String = "_SCALER";
      
      private static const const_1081:String = "_TITLE";
      
      private static const const_1079:String = "_CONTENT";
      
      private static const const_780:String = "margin_left";
      
      private static const const_781:String = "margin_bottom";
      ...
      private var var_1223:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_780,_loc3_.left,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_779,_loc3_.top,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_778,0 - _loc3_.right,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_781,0 - _loc3_.bottom,PropertyStruct.const_65,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1223 == null)
         {
            var_1223 = findChildByTag(const_1080) as IHeaderWindow;
            if(!var_1223)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1081) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1082) as IScalerWindow;
      }
      ...
      {
         return content != null && var_561 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1079) as IWindowContainer;
            if(!var_20)
            {
