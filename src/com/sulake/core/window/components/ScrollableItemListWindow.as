package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_891:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_356)
         {
            var_356 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_356)
            {
               var_356.addEventListener(WindowEvent.const_291,scrollBarEventProc);
               var_356.addEventListener(WindowEvent.const_245,scrollBarEventProc);
            }
         }
         return var_356;
      }
      ...
      override public function dispose() : void
      {
         if(var_356)
         {
            var_356.removeEventListener(WindowEvent.const_291,scrollBarEventProc);
            var_356.removeEventListener(WindowEvent.const_245,scrollBarEventProc);
            var_356 = null;
         }
         if(var_891)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_245)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_891)
         {
            var_891 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_891;
      }
